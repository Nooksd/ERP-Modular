...
export const fetchSlider = createAsyncThunk("slider/fetch-slider", async () => {
  const { data } = await innovaApi.get("/hh/slider/");
  return data;
});
...
export const updateSlider = createAsyncThunk(
  "slider/update",
  async (sliderData) => {
    const { data } = await innovaApi.put("/hh/slider/update", sliderData);
    return data;
  }
);
...
export const sendImage = createAsyncThunk(
  "slider/send-image",
  async (formData) => {
    const { data } = await innovaApi.post("/hh/slider/send-image", formData);
    return data;
  }
);
